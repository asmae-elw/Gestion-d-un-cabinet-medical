                    ...
                    <form class="form-horizontal" action="includes/profile_mod.inc.php" method = "post">
                        ...
                        <?php
                            if (isset($_SESSION['unserId'])) {
                                ...
                                echo "</fieldset><hr>";
                                echo "<h5>Emai : ".$_SESSION['unserEmail']. "  </h5><input type='text'  placeholder='Nouvelle adresse email...' class='form-control' style='width: 500px;' name='email'> <br>";
                                echo "<h5>Date de naissance : ".$_SESSION['unserBirth']. "  </h5><input type='text'  placeholder='Date de naissance...' class='form-control' style='width: 500px;' name='datenaissance'><br>";
                                ...
                                if ($_SESSION['unserTel'] !== 0) {
                                    echo "<h5>Tel : ".$_SESSION['unserTel']. " </h5><input type='text'  placeholder='Votre nouveau numéro...' class='form-control' style='width: 500px;' name='tel'><br>";
                                }else{
                                    echo "<h5>Tel : </h5><input type='number'  placeholder='Votre nouveau numéro...' class='form-control' name='tel'><br>";
                                }
                                if ($_SESSION['unserS']) {
                                    echo "<h5>Groupe Sangin : ".$_SESSION['unserS']. " </h5><input type='text'  placeholder='Votre Group Sangin si connue...' style='width: 500px;' class='form-control' name='GroupS'><br>";
                                }else{
                                    echo '<h5>Groupe Sangin : </h5><input type="text"  placeholder="Votre Group Sangin si connu..." class="form-control" style="width: 500px;" name= "GroupS"> <br>';
                                }
